...
# Load the dataset
file_path = 'Datasets/GridSearchDataset.csv'
...
def smiles_to_descriptors(smiles):
    ...
    if mol:
        descriptors = np.array([Descriptors.MolWt(mol), Descriptors.TPSA(mol), Descriptors.NumHAcceptors(mol),
