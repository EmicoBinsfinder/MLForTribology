...
# Generate scripts for each combination of hidden_dim and num_layers
for hidden_dim in hidden_dims:
    for num_layer in num_layers:
        script_content = script_template.format(hidden_dim=hidden_dim, num_layer=num_layer)
        script_filename = f'generated_scripts/train_hd_{hidden_dim}_nl_{num_layer}.py'
