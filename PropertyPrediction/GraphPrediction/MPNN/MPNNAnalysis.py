...
# Load datasets
train_data_path = '/lustre/scratch/mmm1058/MLForTribology/Datasets/LargeTrainingDataset.csv'
test_data_path = '/lustre/scratch/mmm1058/MLForTribology/Datasets/FinalTestDataset.csv'
...
combined_results_path = '/lustre/scratch/mmm1058/MLForTribology/PropertyPrediction/GraphPrediction/MPNN/MPNNAnalysis/combined_grid_search_results.csv'
