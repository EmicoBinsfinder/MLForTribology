...
# Function to train SVM model for a given property
def train_svm(property_name):
    ...
    # Save trained model
    model_path = f"svm_model_{property_name}.joblib"
    joblib.dump(final_model, model_path)

    print(f"Model for {property_name} trained and saved at {model_path}.")

# Train SVM models for each thermophysical property
...
def explain_model(property_name):
    ...
    # Compute SHAP values using KernelExplainer (SVMs do not support TreeExplainer)
