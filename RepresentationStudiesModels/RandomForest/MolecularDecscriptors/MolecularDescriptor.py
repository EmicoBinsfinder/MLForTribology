...
# Function to train Random Forest model for a given property
def train_rf(property_name):
    ...
    # Save trained model
    model_path = f"rf_model_{property_name}.joblib"
    joblib.dump(final_model, model_path)

    print(f"Model for {property_name} trained and saved at {model_path}.")

# Train Random Forest models for each thermophysical property
